 ...
 * modify 2019-10-14 asuma（lishuaiqiu）
 */
layui.define(['laypage', 'form'], function (exports) {
    ...
    IconFonts.prototype.render = function(options){
        ...
        layui.link("/static/js/layuiext/iconFonts/css/font-awesome.min.css");//font-awesome图标css

        _font_default = $(opts.elem).val()
        ...
        var a = {
            ...
            createSelect: function () {
                if (type=="fontClass"){
                    var str=  '<i class="fa '+_font_default+'"></i>' ;
